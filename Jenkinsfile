    ...
    stages {
        ...
        stage('Build') { 
            ...
            steps {
                ...
                sh 'aws ecs create-service --cluster myapp-cluster --service-name myapp-fargate-service --task-definition myapp-fargate:15f --desired-count 1 --launch-type "FARGATE" --network-configuration "awsvpcConfiguration={subnets=subnet-0f207c5cfef2743a8,securityGroups=sg-08ce3188ffc0733fe,assignPublicIp=ENABLED}"'
